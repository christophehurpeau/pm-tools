...
import { createPackageFilter } from "./createPackageFilter.js";
import { selectExplainedPackages } from "./selectExplainedPackages.js";
const packagesMap = {
    metro: ["metro@0.84.5", "metro@0.87.0"],
    lodash: ["lodash@4.17.21"],
    semver: ["semver@7.6.0"],
};
const select = (filterOptions, all = false) => selectExplainedPackages({
    packagesMap,
...
//# sourceMappingURL=selectExplainedPackages.test.js.map