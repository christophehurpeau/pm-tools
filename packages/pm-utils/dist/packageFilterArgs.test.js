...
import { toPackageFilterOptions, toWhyDuplicateRequest, whyDuplicateParseArgsOptions, } from "./packageFilterArgs.js";
const parseFlags = (args) => parseArgs({
    args,
    options: { ...whyDuplicateParseArgsOptions },
    allowPositionals: true,
});
const parse = (args) => toPackageFilterOptions(parseFlags(args).values);
const request = (args) => {
...
//# sourceMappingURL=packageFilterArgs.test.js.map