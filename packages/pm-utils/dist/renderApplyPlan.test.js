...
import { renderApplyPlan } from "./renderApplyPlan.js";
const escapeStart = "\u001B[";
...
describe("renderApplyPlan", () => {
    it("renders the changes per file and counts them", () => {
        ...
        strictEqual(lastLine(output), "1 change in 1 file. Run `pnpm-dedupe` to apply.");
    });
    it("pluralizes changes and files", () => {
        ...
        strictEqual(lastLine(output), "3 changes in 2 files. Run `pnpm-dedupe` to apply.");
    });
    ...
    it("reports what was skipped even with nothing to apply", () => {
        ...
        ok(output.includes("  - metro in packages/app: no workspace file recorded for it"));
...
//# sourceMappingURL=renderApplyPlan.test.js.map