...
export function buildPackagesMap(packages: BunLockPackages): PackagesMap {
  const resolutionsMap: Record<string, PackageResolution> = {};
...
export function filterDuplicatesPackagesMap(
