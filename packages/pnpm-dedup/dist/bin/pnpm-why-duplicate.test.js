...
const lockNotice = (dir) => `using ${join(realpathSync(dir), "pnpm-lock.yaml")}`;
describe("pnpm-why-duplicate", () => {
    describe("run from a subdirectory", () => {
        ...
        it("names the lockfile it could not find and exits 1", () => {
            ...
            expect(result.stderr.trim()).toBe(`No pnpm-lock.yaml found in ${realpathSync(dir)} or any parent directory`);
        });
    });
});
//# sourceMappingURL=pnpm-why-duplicate.test.js.map