...
export declare const applyClusterFixes: ({ projectDir, dryRun, log, resolve, verifyFrozen, readFixes, readDuplicates, packageManagerResiduals, color, }: ApplyClusterFixesOptions) => ClusterApplyOutcome;
