...
describe("readAndParseYarnLock", () => {
    it("reads a berry lockfile", () => {
        const entries = readAndParseYarnLock(lockPath(`__metadata:
  version: 8
...
`));
    ...
    it("refuses a yarn classic lockfile instead of reporting nothing", () => {
        expect(() => readAndParseYarnLock(lockPath(`# yarn lockfile v1
...
//# sourceMappingURL=readYarnLock.test.js.map