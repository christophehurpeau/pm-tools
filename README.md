...
| ------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| [bun-why-duplicate](packages/bun-why-duplicate)   | <a href="https://npmjs.org/package/bun-why-duplicate"><img src="https://img.shields.io/npm/v/bun-why-duplicate.svg?style=flat-square"></a>   | Simple bin to know why a package is duplicated |
